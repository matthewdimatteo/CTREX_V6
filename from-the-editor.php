...
This is the file for the From the Editor page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-from-the-editor.php')
*/
$pageTitle 	= 'CTREX - From the Editor';	// placed inside html <title> tag
$pageType 	= 'content';				
