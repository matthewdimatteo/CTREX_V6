...
This is the file for the expert approval page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-expert-approval.php')
*/
$pageTitle 	= 'CTREX Expert Approval Form';	// placed inside html <title> tag
$pageType 	= 'content';				
