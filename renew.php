...
This is the file for the renewal page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-renew.php')
*/
$pageTitle 	= 'CTREX Renewals';				// placed inside html <title> tag
$pageType 	= 'content';
