...
This is the file for the login page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-login.php')
*/
$pageTitle 	= 'CTREX Login';		// placed inside html <title> tag
