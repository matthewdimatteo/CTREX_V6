...
This is the file for the site license page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-licenses.php')
*/
$pageTitle 	= 'CTREX Site Licenses';	// placed inside html <title> tag
