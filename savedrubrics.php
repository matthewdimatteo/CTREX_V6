...
This is the file for the saved rubrics page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-savedrubrics.php')
*/
$pageTitle 	= 'CTREX Saved Rubrics';	// placed inside html <title> tag
$pageType 	= 'content';
