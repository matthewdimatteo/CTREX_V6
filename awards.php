...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-awards.php')
*/
$pageTitle 	= 'CTR Award Programs';	// placed inside html <title> tag
