...
This is the file for the workshops and consulting page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-workshops.php')
*/
$pageTitle 	= 'CTREX Workshops and Consulting';	// placed inside html <title> tag
$pageType 	= 'content';				
