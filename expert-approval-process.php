<?php
/*
expert-approval-process.php
By Matthew DiMatteo, Children's Technology Review

This file processes the expert approval form input using the $_POST method
...
After either a success or a failure, the user is redirected back to the page 'expert-approval.php' where a message is displayed
...
$sections 			= array('expert-approval-info', 'expert-approval-codes', 'expert-approval-background');
$sessionItem		= 'expert-approval';
$formSubmissionPage = 'expert-approval.php';
$confirmationPage 	= 'expert-approval.php';
$confirmationMessage= 'Your expert application form has been received.';
$confirmationType	= 'expert-approval';
$emailSubject		= 'CTREX Expert Approval Form Submission';
