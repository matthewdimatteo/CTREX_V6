...
This is the file for the About the Ratings page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-ratings.php')
*/
$pageTitle 	= 'CTREX - About the Ratings';	// placed inside html <title> tag
$pageType 	= 'content';
