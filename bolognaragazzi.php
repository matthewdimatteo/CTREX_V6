...
This is the file for the BolognaRagazzi Digital Award page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-bolognaragazzi.php')
*/
$pageTitle 	= 'BolognaRagazzi Digital Award';	// placed inside html <title> tag
