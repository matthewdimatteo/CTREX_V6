...
This is the file for the full access issue page
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-issue.php')
- However, this file is configured by 'php/content.php' to use the same content file 'php/content/content-issue' as the page 'issue.php'
...
*/
$pageTitle 	= 'CTREX Issue Archive';// placed inside html <title> tag
$pageType 	= 'issue';				
