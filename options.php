...
This is the file for the more options page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-options.php')
*/
$pageTitle 	= 'CTREX - More Options';	// placed inside html <title> tag
$pageType 	= 'content';			
