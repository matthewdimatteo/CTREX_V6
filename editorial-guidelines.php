<?php
/*
editorial-guidelines.php
By Matthew DiMatteo, Children's Technology Review

This is the file for the editorial calendar page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-editorial-guidelines.php')
*/
$pageTitle 	= 'CTREX Editorial Guidelines';	// placed inside html <title> tag
