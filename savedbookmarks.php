...
This is the file for the saved bookmarks page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-savedbookmarks.php')
*/
$pageTitle 	= 'CTREX Saved Bookmarks';	// placed inside html <title> tag
$pageType 	= 'content';
