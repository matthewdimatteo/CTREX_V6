...
This is the file for the Expert Reviewers page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-experts.php')
*/
$pageTitle 	= 'CTREX Expert Reviewers';	// placed inside html <title> tag
$pageType 	= 'content';				
