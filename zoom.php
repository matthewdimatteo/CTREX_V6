...
This is the file for the full-size image page for product reviews
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-zoom.php')
*/
$pageType 	= 'zoom';				// placed inside html <title> tag
