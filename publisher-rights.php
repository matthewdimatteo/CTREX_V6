<?php
/*
publisher-rights.php
By Matthew DiMatteo, Children's Technology Review

This is the file for the awards page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-publisher-rights.php')
*/
$pageTitle 	= 'CTREX - Publishers Bill of Rights';	// placed inside html <title> tag
$pageType 	= 'content';
