...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-editorial-calendar.php')
*/
$pageTitle 	= 'CTREX Editorial Calendar';	// placed inside html <title> tag
