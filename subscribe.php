...
This is the file for the subscribe page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-subscribe.php')
*/
$pageTitle 	= 'CTREX Subscriptions';	// placed inside html <title> tag
