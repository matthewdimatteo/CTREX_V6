...
This is the file for the filters page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-filters.php')
*/
$pageTitle 	= 'CTREX Search Filters';	// placed inside html <title> tag
$pageType 	= 'content';			
