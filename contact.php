...
This is the file for the contact page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-contact.php')
*/
$pageTitle 	= 'CTREX Contact Form';	// placed inside html <title> tag
