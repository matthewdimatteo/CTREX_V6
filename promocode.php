...
This is the file for the promo code page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-promocode.php')
*/
$pageTitle 	= 'CTREX - Enter Promotional Code';	// placed inside html <title> tag
$pageType	= 'content';
