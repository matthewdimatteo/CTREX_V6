...
This is the file for the disclaimer page of the site
...
The content for each page is placed in a file conforming to the naming convention of 'php/content/content-'pagename.php (e.g 'content-disclaimer.php')
*/
$pageTitle 	= 'CTREX - Disclaimer';	// placed inside html <title> tag
